...
@Autonomous(name = "RED_NEAR_ONESHOT", group = "auton")
public class AutonRedNearOneShot extends XAuton {
    ...
    private Pose startPosition = new Pose(120, 120, Math.toRadians(45));
    ...
    public void initialize() {
        ...
        //pinpoint.setStartPose(120, 120, Math.toRadians(45.0));
    ...
    public void buildPaths(){
        ...
        driveStart = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(120, 120, Math.toRadians(45.0)), new Pose(85, 85)))
                .setLinearHeadingInterpolation(Math.toRadians(45), Math.toRadians(45))
                .build();

        leaveLine = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(85, 85), new Pose(85, 59)))
